...
For a purely cable-driven robot without joint motors, we assume $\boldsymbol{\tau} = \mathbf{0}$ (motor torques are zero). This simplifies the Euler-Lagrange equations significantly and is the case for our hybrid serial-cable driven planar robot.

\subsubsection{Simplified Dynamics with $\boldsymbol{\tau} = \mathbf{0}$}
